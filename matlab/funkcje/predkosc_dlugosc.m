...
index1(2)=0;         % tablice indeks�w przednich zboczy impuls�w
index2(2)=0;
...
for i = 1:LP            
    if p1(i)<prog1 && pocz_imp==0    
        elseif p1(i)>=prog1 && pocz_imp==0
            ...
            index1(Nimp1)=i;   % zapami�tanie indeksu przejscia przez pr�g 
...
for i = 1:LP            
    if p2(i)<prog1 && pocz_imp==0    
        elseif p2(i)>=prog1 && pocz_imp==0
            ...
            index2(Nimp2)=i;   % zapami�tanie indeksu przejscia przez pr�g 
